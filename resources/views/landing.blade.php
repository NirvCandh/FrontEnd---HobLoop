...
<head>
    ...
    <style>
        ...
        :root {
            --dark-blue: #002244;
            /* Warna utama Footer & Tombol Custom */
            --danger-red: #dc3545;
            /* Warna Tombol Log In/Join Now */
        }
...
<body>
    ...
    <div class="hero text-white">
        ...
        <div class="container d-flex flex-column justify-content-start align-items-start h-100 pt-5 mt-5">
            <h1 class="display-5 fw-bold" style="max-width: 500px;">Find the Right Job. Build Your Career with HobLoop.
            </h1>
    ...
    <div class="container py-5">
        ...
        <a href="/about-hobloop" class="intro-link-card shadow-lg">
            <div class="intro-container">
                <div class="intro-card-overlay">
                    ...
                    <i class="fa-solid fa-arrow-right arrow d-block mb-3"
                        style="color: var(--dark-blue); font-size: 1.2rem;"></i>

                    <div class="list-unstyled small">
                        <div class="intro-card-list-item">
                            <h6 class="fw-bold mb-0">What we do</h6>
                            <p class="text-muted small mt-1 mb-0">We build a simple, fast hiring platform so companies
                                can manage jobs without stress.</p>
                        </div>
        ...
        <a href="/about-hobloop" class="btn btn-custom-dark px-4 py-2 mt-4">See more <i
