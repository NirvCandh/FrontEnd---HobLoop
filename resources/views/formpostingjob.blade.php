    ...
    <nav class="navbar navbar-expand-lg bg-transparent shadow-0 border-0 p-0">
        <div class="container-fluid p-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <div class="nav-links-box d-flex w-100 justify-content-between">
                    <ul class="navbar-nav nav-gap">
                        <li class="nav-item">
                            <a class="nav-link" href="#">Job Search</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Posting</a>
                        </li>
                    ...
                    <span class="navbar-text ms-auto text-end d-none d-lg-block">
    ...
    <div class="container my-5">
        ...
        <form action="#" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" id="jobAddress" placeholder="" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-secondary-form mb-2 small">Provide the exact job title (e.g., "Backend Engineer,"
                    "Kitchen
                    Staff").</p>
                <input type="text" class="form-control" id="jobTitle" placeholder="" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" id="minEducation" placeholder="" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" style="border: 2px solid #003366" id="description" name="description" rows="5"
                    required></textarea>
            </div>
