        ...
        <div class="profile-card card shadow-sm border-0">
            ...
            <form action="#" method="POST" class="personal-information row g-4">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <select name="gender" class="form-control py-2">
                ...
                <div class="col-12 col-md-4">
                    <p class="text-secondary fw-medium mb-1 small">Upload CV (PDF, max 10 MB)</p>

                    <div class="cv-upload-card p-3 border rounded d-flex flex-column align-items-center justify-content-center"
                        style="cursor: pointer; background-color: #f8f9fa;"
                        onclick="document.getElementById('cvInputFile').click()">

                        <input type="file" id="cvInputFile" name="cv" accept="application/pdf"
                            style="display:none;" />
                        ...
                        <p class="fw-normal mb-1">Click or drag your PDF here</p>
                        <p class="text-secondary fw-medium small mb-0">up to 10 MB</p>
                        <p id="cvFileName" class="small text-truncate mt-2" style="max-width: 300px;"></p>
                    </div>
                </div>
