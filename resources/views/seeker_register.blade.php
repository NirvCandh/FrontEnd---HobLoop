            ...
            <div class="register-login-card-content row justify-content-center">
                <div class="form-content col-12 col-lg-9 col-xl-7 p-4 shadow rounded bg-white">
                    ...
                    <form class="text-start">
                        ...
                        <a class="register-login btn d-block w-100 text-white fw-medium" href="seeker_login">
                            Register
                        </a>
                    ...
                    <!-- Google Login -->
                    <button class="google-button btn w-100 fw-medium d-flex justify-content-center">
